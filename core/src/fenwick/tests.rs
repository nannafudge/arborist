...
impl_tests!{traverse for StatefulTreeViewMut<[usize]> where collection = mut return = &mut}
impl_tests!{seek for StatefulTreeViewMut<[usize]> where collection = mut return = &mut}
